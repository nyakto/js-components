        ...
        it("supports complex templates", function () {
            ...
            expect(parser.template(new Lexer(complexTemplate))).to.be.eql([
                ast.createTag('form')
                    .addAttribute(ast.createAttribute(
                        'method',
                        ast.createExpression(ast.createValue('POST'))
                    ))
                    .addAttribute(ast.createAttribute(
                        'action',
                        ast.createExpression(ast.createValue('/login'))
                    ))
                    .addContent(
                        ast.createTag('input')
                            .addClass('correct', ast.createExpression(ast.createIdentifier('isCorrectUsername')))
                            .setId('username')
                            .addEventBinding(ast.createEventBinding(
                                'change',
                                ['value'],
                                ast.createExpression(ast.createBinaryOperator(
                                    tokens.OP_ASSIGN,
                                    ast.createIdentifier('isCorrectUsername'),
                                    ast.createBinaryOperator(
                                        tokens.OP_LP,
                                        ast.createIdentifier('validateUsername'),
                                        ast.createValue([
                                            ast.createIdentifier('value')
                                        ])
                                    )
                    ...
                    .addContent(
                        ast.createTag('input')
                            .addClass('correct', ast.createExpression(ast.createIdentifier('isCorrectPassword')))
                            .setId('password')
                            .addEventBinding(ast.createEventBinding(
                                'change',
                                ['value'],
                                ast.createExpression(ast.createBinaryOperator(
                                    tokens.OP_ASSIGN,
                                    ast.createIdentifier('isCorrectPassword'),
                                    ast.createBinaryOperator(
                                        tokens.OP_LP,
                                        ast.createIdentifier('validatePassword'),
                                        ast.createValue([
                                            ast.createIdentifier('value')
                                        ])
                                    )
                        ...
                        ast.createTag('button')
                            ...
                            .addEventBinding(ast.createEventBinding(
                                ...
                                ast.createExpression(ast.createBinaryOperator(
                                    ...
                                    ast.createIdentifier('trigger'),
                                    ast.createValue([
                                        ast.createValue('login'),
                                        ast.createBinaryOperator(
                                            tokens.OP_LP,
                                            ast.createBinaryOperator(
                                                tokens.OP_DOT,
                                                ast.createIdentifier('username'),
                                                ast.createIdentifier('getValue')
                                            ),
                                            ast.createValue([])
                                        ),
                                        ast.createBinaryOperator(
                            ...
                            .addContent(ast.createText('Login'))
                    )
            ]);
        });
    });
